...
For our use case, Pandoc can be used to convert a Markdown file into a "LaTeX Beamer" file, which
is a LaTeX document class used for creating presentations. This allows us to write our presentation
in Markdown, which is easier to write and read than LaTeX, and then use Pandoc in our CI/CD
pipeline to convert it into a PDF file that we can share with others.
